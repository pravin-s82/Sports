 ...
 * 
 */
export const GlobalHeaderComponent : CmsComponent<GlobalHeaderDataFragment> = ({ data, children }) => {
...
GlobalHeaderComponent.displayName = "Global Header (Component/GlobalHeader)"
